...
document.addEventListener('DOMContentLoaded', function () {
    ...
    logo.addEventListener('click', function () {
        ...
        // Add 'clicked' class to the "Home" menu item
        menuItems[0].classList.add('clicked');
    ...
    menuItems.forEach(function (menuItem) {
        menuItem.addEventListener('click', function () {
            ...
            // Toggle 'clicked' class on the clicked menu item
...
//         mode.src = "image/dark-mode-icon.svg"
//     } else {
//         mode.src = "image/light-mode-icon.svg"
//     }
// };
...
function renderProjectCards() {
    ...
    projectsWrapper.empty(); // Clear previous content
